  ...
  class CredentialsSetting {
    ...
    init() {
      ...
      if (this.closeUploadNewCertificateButton) {
        this.closeUploadNewCertificateButton.addEventListener('click', this.toggleUploadNewCertBtn.bind(this));
      }
    ...
    toggleLoadingButton() {
      if (this.button?.classList?.contains('button-loading')) {
        ...
        this.button.innerHTML = __('Verifying the credentials...', 'woocommerce-gateway-twint');
