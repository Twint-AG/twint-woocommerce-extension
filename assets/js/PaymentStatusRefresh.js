...
/*!*********************************************************!*\
  !*** ./resources/js/frontstore/PaymentStatusRefresh.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
  ...
  class PaymentStatusRefresh {
    ...
    checkOrderRegularStatus() {
      ...
      if (this.options.orderId !== -1) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(this.options.adminUrl, formData).then(response => {
...
/******/ })()
;
//# sourceMappingURL=PaymentStatusRefresh.js.map