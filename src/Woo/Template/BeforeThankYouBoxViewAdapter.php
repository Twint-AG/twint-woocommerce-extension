...
class BeforeThankYouBoxViewAdapter
{
    ...
    public function render(): void
    {
        ...
        if ($cancelled) {
            echo $this->getCancelledHtml();
        }
    }

    protected function getPaidHtml(): string
    {
        return '<div class="flashbags">
                <div role="alert" class="alert alert-success alert-has-icon">
                    ...
                    <div class="alert-content-container">
                        <div class="alert-content">
                            ' . __('Your payment was successful', 'woocommerce-gateway-twint') . '
                        </div>
                    </div>
                </div>
            </div>';
    ...
    protected function getCancelledHtml(): string
    {
        return '<div class="flashbags">
                    <div role="alert" class="alert alert-danger alert-has-icon">
                        ...
                        <div class="alert-content-container">
                            <div class="alert-content">
                                ' . __('Your order was cancelled.', 'woocommerce-gateway-twint') . '
                            </div>
                        </div>
                    </div>
            </div>';
